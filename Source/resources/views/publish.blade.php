  ...
  <label id="valid" style="color: red">*Please choose any category</label>   
        ...
        <div class="md-form form3">
          ...
          <div class="md-form form4">
            ...
            <input type="text" id="reporter_email" name="reporter_email" class="form-control" value="{{ Auth::user()->email }}">
...
onclick="return delete_funct('{{$user->id}}','{{$user->reporter_email}}')">Delete</a>   <a class="btn btn-danger" href="#" id="views"
